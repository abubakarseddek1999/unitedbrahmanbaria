      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/3 space-y-6">
            {/* Organization Header */}
            <Card className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl shadow-xl border-0 overflow-hidden">
              <CardContent className="p-6">
                ...
                <ScrollArea className="h-[500px]">
                  <div className="p-4 space-y-3">
                    {successStories.map((story, index) => (
                      <div
                        key={story._id}
                        className={`group p-4 rounded-xl border-2 cursor-pointer transition-all duration-300 hover:shadow-lg ${selectedStory._id === story._id
