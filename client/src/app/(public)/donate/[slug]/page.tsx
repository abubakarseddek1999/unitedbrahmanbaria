...
import sslcommerz from "@/asset/images/ssl.png"
...
import { DonatesTypesMenue } from "@/components/donationPage/DonatesTypesMenue"
import FAQ from "@/components/donationPage/FAQ"
  ...
  return (
    <>
      ...
      <div className="bg-muted py-3 text-center text-sm text-muted-foreground">
        <p>সহায়তার জন্য আমাদের সাথে যোগাযোগ করুন ✉️+8801632090523</p>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="bg-card rounded-xl p-8 mb-16 border border-border shadow-md">
            ...
            <p className="text-foreground/80 leading-relaxed mb-4">
              ঐক্যবদ্ধ সদর ব্রাহ্মণবাড়িয়া ফাউন্ডেশন সমাজের সুবিধাবঞ্চিত মানুষের উন্নয়নে নিবেদিত। আপনার প্রতিটি অনুদান সরাসরি আমাদের বিভিন্ন কর্মসূচিতে ব্যয় করা হয় এবং প্রকৃত প্রভাব তৈরি করে।
            </p>
