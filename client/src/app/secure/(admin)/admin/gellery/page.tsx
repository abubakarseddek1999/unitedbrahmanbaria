...
export default function GalleryPage() {
    ...
    const galleryImages: GalleryImage[] = galleryData?.data.map((img: any) => ({
        _id: img._id,
        photo: img.photo || '/placeholder.svg',
        ...
        <main className="min-h-screen bg-background p-6">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="md:text-3xl font-bold dark:text-white">গ্যালারি ব্যবস্থাপনা</h1>
                    <Button onClick={() => setIsCreateOpen(true)} className="gap-2 text-sm md:text-base">
                ...
                <Pagination
                    ...
                    totalPages={galleryData ? Math.ceil(galleryData.meta.total / limit) : 0}
                    limit={limit}
