...
const menuItems = [
  ...
  { name: "members", href: "/secure/admin/members", icon: Users },
  ...
  { name: "SuccessData", href: "/secure/admin/success", icon: BarChart3 },
  { name: "SecreateData", href: "/secure/admin/secreateData", icon: BarChart3 },
  { name: "Gallery", href: "/secure/admin/gellery", icon: ImageIcon },
  { name: "Complain", href: "/secure/admin/complain", icon: ImageIcon },
          ...
          <div className={`flex items-center gap-3 p-2 rounded-lg ${darkMode ? "bg-gray-800" : "bg-gray-100"} ${!sidebarOpen && "justify-center"}`}>
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs truncate ${textSecondary}`}>UnityBrahmanbaria</p>
              </div>
            )}
