...
import PhotoCollageMini from "../../secreateData/Components/PhotoCollegeMini"
            ...
            <Card className="hover:shadow-md transition-shadow flex flex-col-reverse md:flex-row gap-2  border-l-4 border-l-red-500 p-2 md:p-5">
                ...
                <div className="w-full md:w-1/2">
                    <div className="flex items-start justify-between my-3">
                        <h4 className="font-bold text-base md:text-xl text-gray-900 dark:text-white leading-tight pr-4">{complaint.title}</h4>
                    </div>

                    <p className="text-gray-700 dark:text-gray-400 leading-relaxed mb-4 line-clamp-4 text-xs md:text-base">{complaint.description}</p>
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-4 text-sm text-gray-600 dark:text-gray-400">
                        <div className="flex items-center gap-1">
                            ...
                            <span>
                                জমাদাতা: <span className="font-medium text-gray-800 dark:text-gray-400">{complaint.name}</span>
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <Link href={`/secure/admin/complaint-details/${complaint._id}`}>
