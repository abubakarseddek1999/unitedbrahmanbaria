...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="px-2 py-1 cursor-pointer text-sm font-semibold border border-primary text-primary rounded-lg hover:bg-primary hover:text-white transition whitespace-nowrap"
    >
      {currentLanguage === 'bn' ? 'English' : 'Bengali'}
    </button>
  )
}